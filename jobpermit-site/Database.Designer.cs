...
namespace jobpermit_site.DatabaseTableAdapters {
    ...
    public partial class TBLADMINTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["JOBPERMITConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "DELETE from TBLADMIN WHERE ID=@ID";
            ...
            this._commandCollection[2].CommandText = "SELECT  * FROM TBLADMIN WHERE ID=@ID";
            ...
            this._commandCollection[3].CommandText = "UPDATE TBLADMIN SET USERNAME=@USERNAME,PASSWORD=@PASSWORD WHERE ID=@ID";
        ...
        public virtual int Fill(Database.TBLADMINDataTable dataTable) {
        ...
        public virtual Database.TBLADMINDataTable getUsers() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database.TBLADMINDataTable dataTable = new Database.TBLADMINDataTable();
        ...
        public virtual int FillBy(Database.TBLADMINDataTable dataTable, int ID) {
        ...
        public virtual Database.TBLADMINDataTable getUsersData(int ID) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(ID));
            Database.TBLADMINDataTable dataTable = new Database.TBLADMINDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database.TBLADMINDataTable dataTable) {
        ...
        public virtual int deleteUsers(int ID) {
        ...
        public virtual int updateUsers(string USERNAME, string PASSWORD, int ID) {
